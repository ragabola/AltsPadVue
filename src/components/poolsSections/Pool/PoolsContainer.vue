      ...
      <div class="upcomning" v-show="upcoming">
        <div class="flex-pool">
          <PoolItem
            ...
            :Showledgity="pool.showledgity"
            :Showsolana="pool.showsolana"
            :Showterra="pool.showterra"
            :Showpolygon="pool.showpolygon"
            :Showftmscan="pool.showftmscan"
            :Showetherscan="pool.showetherscan"
            :Showbascan="pool.showbascan"
